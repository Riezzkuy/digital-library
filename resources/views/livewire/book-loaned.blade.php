<div class="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
    ...
    @foreach ($this->books as $book )
        <div wire:key="{{ $book->id }}" class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="h-56 w-full">
                <a href="#">
                <img class="mx-auto h-full" src="{{ $book->getCoverUrl() }}" alt="" />
                <img class="mx-auto hidden h-full" src="{{ $book->getCoverUrl() }}" alt="" />
                </a>
            </div>
            <div class="pt-6">
                <div class="mb-4 flex items-center justify-between gap-4">
                <span class="me-2 rounded bg-blue-100 px-2.5 py-0.5 text-xs font-medium text-blue-800 dark:bg-blue-900 dark:text-blue-300"> {{ $book->status }}</span>
                ...
                <a wire:navigate href="{{ route('books.show', $book->slug) }}" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{{ $book->title }}</a>
                ...
                <a wire:navigate href="{{ route('books.read', $book->slug) }}" class="inline-flex items-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
