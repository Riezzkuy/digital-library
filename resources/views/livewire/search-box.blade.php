<div x-data="{
    ...
    <input x-model="query"
        ...
        placeholder="{{__('Find books here...')}}" required />
    <button x-on:click="$dispatch('search', {
        search : query
    })" class="text-white absolute end-2.5 bottom-2.5 bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">{{__('Search')}}</button>
</div>
